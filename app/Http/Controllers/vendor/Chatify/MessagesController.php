...
class MessagesController extends Controller
{
    ...
    public function index($id = null)
    {
        ...
        return view('Chatify::pages.app', [
            ...
            //'messengerColor' => '#2180f3'Auth::user()->messenger_color,
            'dark_mode' => 'light',
            //'dark_mode' => 'light'Auth::user()->dark_mode < 1 ? 'light' : 'dark',
        ]);
    }
    ...
    public function fetch(Request $request)
    {
        ...
        return Response::json([
            'count' => $query->count(),
            'messages' => '<p class="message-hint"><span>Mulai percakapan..</span></p>',
        ]);
    }
    ...
    public function getContacts(Request $request)
    {
        ...
        // send the response
        return Response::json([
            'contacts' => $users->count() > 0 ? $contacts : '<br><p class="message-hint"><span>List chat kosong</span></p>',
        ], 200);
    }
    ...
    public function search(Request $request)
    {
        ...
        return Response::json([
            'records' => $records->count() > 0
                ? $getRecords
                : '<p class="message-hint"><span>Member tidak ditemukan.</span></p>',
            'addData' => 'html'
        ], 200);
    }
