                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap py-3">
                        <div class="card-title">
                            <h3 class="card-label">Reporting - Hasil Kuesioner Ibu Hamil
                            <span class="d-block text-muted pt-2 font-size-sm">Halaman ini menampilkan data hasil kuisioner ibu hamil</span></h3>
                        </div>
                    </div>
                ...
                <div class="card card-custom gutter-b" id="grafik-hasil">
                    ...
                    <div class="card-body">
                        <div class="row" style="margin-top: 2%">
                             @for ($i = 0; $i < 20; $i++)
                            <div class="col-lg-6 mb-10" id="own-{{ $i }}" style="width:500px">
    ...
    $(document).ready(function() {
        ...
        $('#lihat').on('click', function() {
            ...
            if (kuesioner == '') {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('admin.rephamil.search') }}',
                    data: { 
                        "_token": "{{ csrf_token() }}", 
                        "kuesioner": kuesioner, 
                        "tanggal": tanggal, 
