                    ...
                    <form method="POST" action="{{ route('admin.memberhamil.update', $member->id) }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $member->no_telp }}" name="no_telp" required />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jk" name="status_nikah" required>
                                    <option value="1" {{$member->status_pernikahan == 1 ? "selected" : null}}>Sudah Menikah</option>
                                    <option value="0" {{$member->status_pernikahan == 0 ? "selected" : null}}>Belum Menikah</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jk" name="status_hamil" required>
                                    <option value="1" {{$member->status_hamil == 1 ? "selected" : null}}>Sedang Hamil</option>
                            ...
                            <div class="form-group row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $member->provinsi }}" disabled />
                                        </select>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $member->kabupaten }}" disabled />
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $member->kecamatan }}" disabled />
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Kelurahan</label>
                                        <input type="text" class="form-control" value="{{ $member->kelurahan }}" disabled />
                                    </div>
                                </div>
                            </div>
