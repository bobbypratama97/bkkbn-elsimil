    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid">
                ...
                <form class="form" method="POST" action="{{ route('admin.pertanyaan.submit') }}" id="frmSort">
                    @csrf
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Sorting Pertanyaan</h3>
                        </div>
                        @csrf
                        <div class="card-body">
                            <ul id="sortable">
                                ...
                                <li class="ui-state-default" id="{{ $row->id }}">
                                    <span class="ui-icon ui-icon-arrowthick-2-n-s"></span>{{ $row->caption }}
                                </li>
                                @endforeach
                            </ul>
                        ...
                        <div class="card-footer bg-gray-100 border-top-0">
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    <a href="{{ route('admin.pertanyaan.index', $id) }}" class="btn btn-danger">Batal</a>
                                </div>
                            </div>
                        </div>
                    </div>
