                        ...
                        <div class="card card-custom gutter-b example-hover bg-light">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <a href="{{ route('kua.couples', $output['mine']) }}" class="btn btn-success font-weight-bolder mr-3">Lihat Pasangan</a>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card-body py-4">
                                            <div class="form-group row my-0">
                                                ...
                                                <div class="col-10">
                                                    <span class="form-control-plaintext font-weight-bolder">Nama : {{ $vv['member']->name }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row my-0">
                                                <label class="col-1 col-form-label"><i class="flaticon2-website"></i></label>
                                                <div class="col-10">
                                                    <span class="form-control-plaintext font-weight-bolder">ID Profile : {{ $vv['member']->profile_code }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row my-0">
                                                <label class="col-1 col-form-label"><i class="flaticon-rotate"></i></label>
                                                <div class="col-10">
                                                    <span class="form-control-plaintext font-weight-bolder">Gender : {!! Helper::jenisKelamin($vv['member']->gender) !!}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="card-body py-4">
                                            <div class="form-group row my-0">
                                                <label class="col-1 col-form-label"><i class="flaticon2-user"></i></label>
                                                <div class="col-10">
                                                    <span class="form-control-plaintext font-weight-bolder">Usia : {!! Helper::diffDate('', $vv['member']->tgl_lahir, 'y') !!}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row my-0">
                                                <label class="col-1 col-form-label"><i class="flaticon-calendar-with-a-clock-time-tools"></i></label>
                                                <div class="col-10">
                                                    <span class="form-control-plaintext font-weight-bolder">Tempat / Tgl Lahir : {{ $vv['member']->tempat_lahir }}, {!! Helper::customDateMember($vv['member']->tgl_lahir) !!}</span>
                                                </div>
                                            </div>
                                            <div class="form-group row my-0">
                                                <label class="col-1 col-form-label"><i class="flaticon-placeholder-3"></i></label>
                                                <div class="col-10">
                                                    <span class="form-control-plaintext font-weight-bolder">Lokasi : {{ $vv['member']->kelurahan }}, {{ $vv['member']->kecamatan }}, {{ $vv['member']->kabupaten }}, {{ $vv['member']->provinsi }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
