                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap py-3">
                        <div class="card-title">
                            <h3 class="card-label">Provinsi 
                            <span class="d-block text-muted pt-2 font-size-sm">Halaman ini menampilkan data provinsi</span></h3>
                        </div>
                        @can('access', [\App\Provinsi::class, Auth::user()->role, 'upload'])
                        <div class="card-toolbar">
                            <div class="col text-left">
                                <a href="{{ route('admin.provinsi.template') }}" class="btn btn-warning">Download Template Provinsi</a>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap;">
                                        @can('access', [\App\Provinsi::class, Auth::user()->role, 'edit'])
                                        <a href="{{ route('admin.provinsi.edit', $row->id) }}" class="btn btn-icon btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Ubah">
                                            <i class="flaticon2-edit"></i>
                                        </a>
                                        @endcan
                                        @can('access', [\App\Provinsi::class, Auth::user()->role, 'delete'])
