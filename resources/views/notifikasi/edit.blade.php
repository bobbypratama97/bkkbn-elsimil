...
<style>
    ...
    .customPosImg { border-radius: 0px !important; margin-left: auto !important; margin-right: auto !important; width: 100% !important; height: 75% !important; }
</style>
@endpush
            ...
            <div class="container-fluid">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Ubah Notifikasi</h3>
                    </div>
                    <form class="form" method="POST" action="{{ route('admin.notifikasi.update', $data->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input id="img-thumb" name="thumbnail" type="hidden" value="{{ $data->image }}">
                                ...
                                <div class="col-lg-9">
                                    <div class="form-group">
                                        <label>Judul</label>
                                        <input type="text" class="form-control" id="title" name="title" maxlength="200" value="{{ $data->title }}" required oninvalid="this.setCustomValidity('Judul harus diisi')" oninput="setCustomValidity('')" />
                                    </div>
...
<script type="text/javascript">
    ...
    $('#dropzone').dropzone({
        ...
        init: function() {
            ...
            var urlthumb = baseurl + "/uploads/notif/" + "{{ $data->image }}";
            var mockFile = { name: "{{ $data->image }}", size: 12345, type: 'image/jpeg' };
