        ...
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <form class="form" method="POST" action="{{ route('admin.kecamatan.update', $camat->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" value="{{ $camat->provinsi_kode }}" disabled />
                                </div>
                                <div class="col-lg-6">
                                    <label>Provinsi</label>
                                    <input type="text" class="form-control" value="{{ $camat->provinsi }}" disabled />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" value="{{ $camat->kabupaten_kode }}" disabled />
                                </div>
                                <div class="col-lg-6">
                                    <label>Kabupaten</label>
                                    <input type="text" class="form-control" value="{{ $camat->kabupaten }}" disabled />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" value="{{ $camat->kecamatan_kode }}" disabled />
                                </div>
                                <div class="col-lg-6">
                                    <label>Kecamatan</label>
                                    <input type="text" class="form-control" name="nama" value="{{ $camat->nama }}" required oninvalid="this.setCustomValidity('Kecamatan harus diisi')" oninput="setCustomValidity('')" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="publikasi" name="publikasi" required oninvalid="this.setCustomValidity('Status publikasi harus dipilih')" oninput="setCustomValidity('')" >
                                    ...
                                    <option value="{{ $key }}" {{ $key == $camat->status ? 'selected' : '' }}>{{ $val }}</option>
                                    @endforeach
                                </select>
                            </div>
