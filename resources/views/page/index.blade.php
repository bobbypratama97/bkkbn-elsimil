                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap py-3">
                        <div class="card-title">
                            ...
                            <span class="d-block text-muted pt-2 font-size-sm">Halaman ini menampilkan single page</span></h3>
                        </div>
                        @can('access', [\App\Page::class, Auth::user()->role, 'create'])
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @endcan
                                        @can('access', [\App\Page::class, Auth::user()->role, 'show'])
                                        <a href="{{ route('admin.page.show', $row->id) }}" class="btn btn-icon btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Ubah">
                                            <i class="flaticon2-menu-1"></i>
                                        </a>
                                        @endcan
                                        @can('access', [\App\Page::class, Auth::user()->role, 'delete'])
