                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap py-3">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('newskategori.create') }}" class="btn btn-primary font-weight-bolder">
                        ...
                        <table class="table table-bordered table-checkable" id="kt_datatable" style="border-collapse: collapse; border-spacing: 0; width: 100% !important;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('newskategori.edit', $row->id) }}" class="btn btn-icon btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Ubah">
                            ...
                            bootbox.dialog({
                                ...
                                buttons: {
                                    ok: {
                                        ...
                                        className: 'btn-info',
                                        callback: function() {
                                            window.location.href = '{{ route('newskategori.index') }}';
                                        }
                                    }
                                }
                            });
