                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap py-3">
                        ...
                        <div class="card-toolbar">
                            @can('access', [\App\Role::class, Auth::user()->role, 'setting'])
                            <a href="{{ route('admin.role.setting') }}" class="btn btn-success font-weight-bolder mr-3">
                            ...
                            @can('access', [\App\Role::class, Auth::user()->role, 'create'])
                        ...
                        <table class="table table-bordered table-checkable" id="kt_datatable" style="border-collapse: collapse; border-spacing: 0; width: 100% !important;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('access', [\App\Role::class, Auth::user()->role, 'edit'])
                                        <a href="{{ route('admin.role.edit', $row->id) }}" class="btn btn-icon btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Ubah">
                                            <i class="flaticon2-writing"></i>
                                        </a>
                                        @endcan
                                        @can('access', [\App\Role::class, Auth::user()->role, 'show'])
                                        <a href="{{ route('admin.role.show', $row->id) }}" class="btn btn-icon btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Detail">
