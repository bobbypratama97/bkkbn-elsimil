        ...
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <form class="form" method="POST" action="{{ route('admin.kategori.update', $data->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{ $data->name }}" required oninvalid="this.setCustomValidity('Nama kategori harus diisi')" oninput="setCustomValidity('')" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="warna" value="{{ $data->color }}" id="colorpicker" oninvalid="this.setCustomValidity('Nama kategori harus diisi')" oninput="setCustomValidity('')" autocomplete="off" >
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $('#dropzone').dropzone({
        ...
        init: function() {
            ...
            var urlthumb = baseurl + "/uploads/artikel_kategori/" + "{{ $data->thumbnail }}";
